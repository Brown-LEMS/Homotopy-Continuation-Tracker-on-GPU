#ifndef DEV_EVAL_INDXING_GENERALIZED_2VIEWS_6PTS_PLUCKER_CUH
#define DEV_EVAL_INDXING_GENERALIZED_2VIEWS_6PTS_PLUCKER_CUH
// =================================================================================================
// Device function for evaluating the Jacobians ∂H/∂x, ∂H/∂t, and H
//
// Modifications
//    Chiang-Heng Chien  25-07-31:   BUild on top of generalized_3views_4pts
//
// =================================================================================================
#include <cstdio>
#include <iostream>

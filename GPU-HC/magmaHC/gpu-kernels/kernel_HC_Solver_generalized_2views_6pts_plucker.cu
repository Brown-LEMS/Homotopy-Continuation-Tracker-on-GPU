#ifndef KERNEL_HC_solver_generalized_2views_6pts_plucker_CU
#define KERNEL_HC_solver_generalized_2views_6pts_plucker_CU
// =============================================================================================================
// GPU homotopy continuation solver for Generalized Two-View Relative Pose Problem from 6 points
//
// Modifications
//    Chiang-Heng Chien  25-07-31:   Build on top of generalized_3views_4pts.cu
//
...
//> device functions
#include "../gpu-idx-evals/dev-eval-indxing-generalized_2views_6pts_plucker.cuh"
...
__global__ void
HC_solver_generalized_2views_6pts_plucker(
...
real_Double_t
kernel_HC_Solver_generalized_2views_6pts_plucker(
...
)
{
  ...
  const int num_of_coeffs_from_params = 168;
  const int dHdx_Max_Terms            = 16;
  const int dHdx_Max_Parts            = 4;
  const int dHdt_Max_Terms            = 40;
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(HC_solver_generalized_2views_6pts_plucker \
  ...
  e = cudaLaunchKernel((void*)HC_solver_generalized_2views_6pts_plucker \
                        < num_of_vars, num_of_coeffs_from_params, max_order_of_t, \
                          dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdx_Row_Offset, \
                          dHdt_Max_Terms, dHdt_Max_Parts, dHdt_Row_Offset, \
                          Full_Parallel_Offset, \
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of HC_solver_generalized_2views_6pts_plucker is not successful!\n");
